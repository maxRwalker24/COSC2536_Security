...
# Create keys
def generate_keys(priv_key_path, pub_key_path):
...
def main():
    priv_key_path = os.path.join(BASE, "keys", "private_key.pem")
    pub_key_path = os.path.join(BASE, "keys", "pub_key.pem")
    # Generate RSA keys
    private_key, public_key = generate_keys(priv_key_path, pub_key_path)
